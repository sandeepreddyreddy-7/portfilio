...
const experiences = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Designed SSO/SAML federated identity (IBM Liberty + ProcessUnity SaaS) and SendGrid email infrastructure and establishing secure identity and notification foundation for the TPRM program",
