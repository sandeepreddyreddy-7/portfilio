...
const socials = [
  {
    icon: Mail,
    label: "Email",
    value: "sandeepreddy@email.com",
    href: "mailto:sandeepreddy@email.com",
    color: "#3B82F6",
  ...
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "linkedin.com/in/sandeep-reddy",
    href: "https://linkedin.com/in/sandeep-reddy",
    color: "#0A66C2",
  ...
  },
  {
    icon: Github,
    label: "GitHub",
    value: "github.com/sandeepreddy",
    href: "https://github.com/sandeepreddy",
    color: "#94A3B8",
          ...
          >
            {submitted ? (
              <div className="glass rounded-2xl p-10 border border-[#1E2A45]/60 flex flex-col items-center justify-center text-center h-full min-h-[360px]">
                ...
                <p className="text-[14px] text-[#475569]">Thanks for reaching out. I&apos;ll get back to you within 24 hours.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 border border-[#1E2A45]/60 space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-[12px] font-semibold text-[#475569] uppercase tracking-wider block mb-2">
                      Name
                    </label>
                    <input
                      type="text"
